...
@Component({
  ...
  template: `
    <p-dialog header="Detalle del Transporte" [(visible)]="display" (onHide)="onClose.emit()">
      <div *ngIf="transporte">
        ...
        <button pButton type="button" label="Marcar como Finalizado" (click)="completeTransporte()"></button>
      </div>
    </p-dialog>
  `,
  styles: [``]
